...
@section('titulo', 'Registro departamentos')
@section('content')
    <h2 class="texto-blanco pt-5 pb-3">Registrar nuevo departamento</h2>
    @if ($errors->any())
                ...
                <div class="col">
                    <div class="mb-2">
                        <div class="mb-2">
                            ...
                            <input type="text" name="nombre" id="nombre" placeholder="Tolima"
